...
public class Add extends Function
{
	...
	public Number eval(Number n)
	{
		...
		if ((n1 instanceof Indeterminate) || (n2 instanceof Indeterminate) || (n1 instanceof Infinity && n2 instanceof NegInfinity) || (n2 instanceof Infinity && n1 instanceof NegInfinity))
			return (new Indeterminate());
		else if (n1 instanceof Infinity || n2 instanceof Infinity)
			return (new Infinity());
		else if (n1 instanceof NegInfinity || n2 instanceof NegInfinity)
	...
	public Function der()
	{
		return new Add(f1.der(), f2.der()).simplify();
	}
	...
	public Function simplify()
	{
		...
		if (f1 instanceof Constant && f2 instanceof Constant)
			...
			return (new Multiply(new Constant(2), new VariableReturn()));
		else
